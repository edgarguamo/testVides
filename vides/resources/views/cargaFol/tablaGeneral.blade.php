...
@section('archivo')
    ...
    <div class="overflow-x-auto">
        <table id="archivos" align="center" class="table table-bordered table-striped " style="width:90%">
    ...
    <button type="button" class="border bg-gray-800  text-white rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-white hover:text-gray-800 focus:outline-none focus:shadow-outline">
        <a href="/carga" class="">Cerrar tabla</a>
    </button>
